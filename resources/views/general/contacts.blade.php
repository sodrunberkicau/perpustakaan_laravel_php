                ...
                <div class="card position-relative top-50 start-50 translate-middle" style="padding: 16px; cursor: pointer; box-shadow: 0px 4px 10px #00000010">
                    <div class="card-body" style="display:grid;">
                        ...
                        <span class="urbanist-semibold"
                            style="font-size: 20px; color: white; margin-top: 24px;">Lokasi</span>
                        <span class="amaranth-regular" style="font-size: 16px; color: #7F7F7F; margin-top: 4px;">Jl. Raya Gadung
                            No.80-91</span>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card position-relative top-50 start-50 translate-middle" style="padding: 16px; cursor: pointer; box-shadow: 0px 4px 10px #00000010">
                    <div class="card-body" style="display:grid;">
                        ...
                        <span class="urbanist-semibold"
                            style="font-size: 20px; color: white; margin-top: 24px;">Whatsapp</span>
            ...
            <div class="col">
                <div class="card position-relative top-50 start-50 translate-middle" style="padding: 16px; cursor: pointer; box-shadow: 0px 4px 10px #00000010">
                    <div class="card-body" style="display:grid;">
                        ...
                        <span class="urbanist-semibold"
                            style="font-size: 20px; color: white; margin-top: 24px;">Email</span>
